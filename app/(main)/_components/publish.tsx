...
const Publish = ({ initialData }: PublishProps) => {
  ...
  const url = `${origin}/preview/${initialData._id}`; // with this we can get what is the url that the user can share with guests to look at the published note we have
